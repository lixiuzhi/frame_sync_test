...
namespace Pathfinding
{
	public class ABPath : Path
	{
		...
		public static ABPath Construct(ref Int3 start, ref Int3 end, OnPathDelegate callback = null)
		{
		...
		protected void UpdateStartEnd(ref Int3 start, ref Int3 end)
		{
		...
		public override void Reset()
		{
			...
			this.startHint = null;
			this.endHint = null;
			this.originalStartPoint = Int3.zero;
			this.originalEndPoint = Int3.zero;
			this.startPoint = Int3.zero;
			this.endPoint = Int3.zero;
		...
		public override void Initialize()
		{
			...
			if (this.pathHandler.HeapEmpty())
			{
				...
				{
					base.Error();
					Logger.err("No open points, the start node didn't open any nodes");
					return;
				}
		...
		public override void CalculateStep(long targetTick)
		{
			...
			while (base.CompleteState == PathCompleteState.NotCalculated)
			{
				...
				{
					base.Error();
					Logger.err("No open points, whole area searched");
					return;
				}
				this.currentR = this.pathHandler.PopNode();
				if (num > 500)
