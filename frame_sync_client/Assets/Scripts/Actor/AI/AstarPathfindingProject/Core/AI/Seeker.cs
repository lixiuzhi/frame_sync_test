...
public class Seeker : MonoBehaviour
{
    ...
    [NonSerialized]
    public List<Int3> lastCompletedVectorPath;
    ...
    public ABPath GetNewPath(ref Int3 start, ref Int3 end)
    {
        return ABPath.Construct(ref start, ref end, null);
    }

    public Path StartPathEx(ref Int3 start, ref Int3 end, OnPathDelegate callback = null, int graphMask = -1)
    {
