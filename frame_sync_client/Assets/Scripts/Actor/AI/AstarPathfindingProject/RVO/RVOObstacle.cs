    ...
    public abstract class RVOObstacle : MonoBehaviour
    {
        ...
        public void OnDrawGizmos(bool selected)
        {
            ...
            for (int i = 0; i < this.gizmoVerts.Count; i++)
            {
                ...
                if (selected)
                {
                    float num2 = (float)this.Height * 0.001f;
                    int k = 0;
                    int num3 = array.Length - 1;
                    while (k < array.Length)
                    {
                        Gizmos.DrawLine(matrix.MultiplyPoint3x4((Vector3)array[k]) + Vector3.up * num2, matrix.MultiplyPoint3x4((Vector3)array[num3]) + Vector3.up * num2);
                        Gizmos.DrawLine(matrix.MultiplyPoint3x4((Vector3)array[k]), matrix.MultiplyPoint3x4((Vector3)array[k]) + Vector3.up * num2);
                        num3 = k++;
                    }
                    int l = 0;
                    ...
                    {
                        Vector3 vector = matrix.MultiplyPoint3x4((Vector3)array[num4]);
        ...
        public void Start()
        {
            ...
            this.sourceObstacles = new List<Int3[]>();
        ...
        protected void AddObstacle(Int3[] vertices, int height)
        {
            ...
            {
                Int3[] array = new Int3[vertices.Length];
