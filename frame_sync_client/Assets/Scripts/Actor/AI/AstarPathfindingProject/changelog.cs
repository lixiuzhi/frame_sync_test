...
- next
	...
	- Changes
		...
		- Moved internal fields of NNInfo into a new NNInfo struct to make the API easier to use. Previously NNInfo contained some internal fields, but now they are only in NNInfo.
...
- 3.8 (2016-02-16)
	...
	- Changes
		...
		- Removed IntVector2.sqrMagnitude, IntVector2.Dot since they were not used anywhere and are prone to overflow (use sqrMagnitudeLong/DotLong instead)
		- Deprecated IntVector2.Rotate since it was not used anywhere.
...
- 3.7 (2015-07-22)
	...
	- Changes
		...
		- Removed some methods which have been marked as obsolete for a very long time.
			...
			- IntVector3.safeMagnitude and safeSqrMagnitude
